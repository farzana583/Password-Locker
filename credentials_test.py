...
class TestCredentials(unittest.TestCase):
    def setUp(self):
        ...
        self.new_credentials = Credentials("Farzana","Isack","123456","farzana@m.com") # create Account object
 ...
 self.new_credentials.save_credentials() # saving the new account
    ...
    def test_save_multiple_credentials(self):
            ...
            test_credentials = Credentials("Test","user","0707072241","test@user.com") # new account
            ...
            '''
            self.new_credentials.save_credentials()
            test_credentials = Credentials("Test","user","0707072241","test@user.com") # account
            test_credentials.save_credentials()
    ...
    def test_credentials_exists(self):
        ...
        credentials_exists = Credentials.credentials_exist("0707072241")
